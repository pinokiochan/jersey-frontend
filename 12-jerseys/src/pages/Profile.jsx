...
import { User, Mail, Calendar, Package, Settings, Edit3, Save, X } from "lucide-react"
                ...
                <div>
                  ...
                  {orders.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600">Оформите первый заказ в нашем каталоге</p>
                    </div>
                  ) : (
                    <div className="space-y-6">
                      {orders.map((order) => (
                        <div key={order.id} className="border border-gray-200 rounded-xl p-6">
                          <div className="flex items-center justify-between mb-4">
                            <div>
                              ...
                              <p className="text-gray-600">{new Date(order.date).toLocaleDateString("ru-RU")}</p>
                            </div>
